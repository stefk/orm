...
class EntityManagerGenerator implements EntityManagerGeneratorInterface
{
    ...
    private function generateDynamicEntityManager()
    {
        ...
        $sourceCode .= "use Anytime\ORM\EntityManager\DBConnection;\n";
        ...
        $sourceCode .= "\n";
        $sourceCode .= "    public function __construct(DBConnection \$DBConnection, SnakeToCamelCaseStringConverter \$snakeToCamelCaseStringConverter, DynamicRepositories \$dynamicRepositories, DynamicManagers \$dynamicManagers, QueryBuilderFactory \$queryBuilderFactory, string \$databaseType, \$databaseName = null)\n";
        $sourceCode .= "    {\n";
        $sourceCode .= "        \$this->repositories = \$dynamicRepositories;\n";
        $sourceCode .= "        \$this->managers = \$dynamicManagers;\n";
        $sourceCode .= "        parent::__construct(\$DBConnection, \$snakeToCamelCaseStringConverter, \$queryBuilderFactory, \$databaseType, \$databaseName);\n";
        $sourceCode .= "    }\n";
        $sourceCode .= "}\n\n";
    ...
    private function generateDynamicManagers(array $tableStructList)
    {
        ...
        // Constructor
        $sourceCode .= "    public function __construct(DBConnection \$DBConnection, DynamicRepositories \$dynamicRepositories) {\n";
        $sourceCode .= "        \$this->dynamicRepositories = \$dynamicRepositories;\n";
        $sourceCode .= "        parent::__construct(\$DBConnection);\n";
        $sourceCode .= "    }\n";
